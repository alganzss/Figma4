...
import { QrCode, FileText, ClipboardList, Users, Cloud } from 'lucide-react';
...
import qrCode3 from 'figma:asset/2932f728a6346cf406deb58a0c2466dadce60bab.png';
...
export function CompetitionGuide() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-400 via-blue-400 to-blue-500 py-16 px-4 relative overflow-hidden">
      ...
      {/* QR Code Cards Grid */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 relative z-10">
